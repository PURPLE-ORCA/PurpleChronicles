...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 sm:`">
            <header className="">
            <nav className="flex items-center justify-between p-4">
                    <img className="w-14" src="/img/ChroniclesOwl.png" alt="Logo" />
                    <Link href="/">
                        <div className="font-bold text-xl text-black dark:text-white">PURPLE CHRONICLES</div>
                    </Link>
                        {/* Theme Toggle */}
                        <div>
                        <button
                        ...
                        >
                            {isDarkMode ? (
                                <i className="bx bx-sun text-xl text-black dark:text-white"></i>
                            ) : (
                                <i className="bx bx-moon text-xl text-black dark:text-white"></i>
                            )}
                        </button>
                        <i className="bx bx-menu-alt-right text-2xl cursor-pointer text-black dark:text-white" onClick={toggleSidebar}></i>
                    </div>
                </nav>
            </header>
